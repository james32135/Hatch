...
export default function Notifications() {
  ...
  const items: any[] = [];
  (handoffs.data?.handoffs || []).forEach((h: any) =>
    items.push({
      kind: "handoff",
      tone: "warn",
      text: "This week's investment needs your approval",
      at: h.createdAt,
    }),
  );
  if (readiness.data && readiness.data.nextStep !== "READY") {
